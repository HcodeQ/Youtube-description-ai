...
import type { VideoPreview as VideoPreviewType, FormData } from "@/types"

export function YoutubeDescriptionGenerator() {
  const [videoUrl, setVideoUrl] = useState("")
  const [videoPreview, setVideoPreview] = useState<VideoPreviewType | null>(null)
  ...
  const handleVideoUrlChange = (url: string) => {
    ...
    // Simulate fetching video details when a valid YouTube URL is entered
    if (url.includes("youtube.com/watch") || url.includes("youtu.be/")) {
      // In a real app, you would fetch the actual video data from YouTube API
      setVideoPreview({
        title: "How to Master Next.js in 2024 - Complete Tutorial",
