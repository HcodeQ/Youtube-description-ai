...
import type { FormData, TranscriptionSettings, VideoPreview as VideoPreviewType } from "@/types"
import { submitTranscriptionData } from "@/lib/api"
...
export function TranscriptionForm({ onVideoUrlChange, videoUrl, videoPreview }: TranscriptionFormProps) {
